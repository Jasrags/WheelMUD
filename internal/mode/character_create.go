...
// messages rendered verbatim to the terminal (see handleLegacy /
// handleName → writeError → display.Error). Sentence-case is
// intentional and matches the neighboring writeError calls;
// staticcheck's lowercase-error-string rule (ST1005) is the wrong
