...
const charCoreColumns = `size, type, gender, alignment,
		...
		hp_current, hp_max, subdual,
		stamina_current, stamina_max, stamina_regen,
		hit_dice,
...
func charCoreValues(c Character, drJSON, resistsJSON, affectsJSON string) []any {
	...
	return []any{
		...
		core.HPCurrent, core.HPMax, core.Subdual,
		core.StaminaCurrent, core.StaminaMax, core.StaminaRegen,
		core.HitDice,
...
func charPlayerValues(c Character, classLevelsJSON, featsJSON, skillsJSON, classFeaturesJSON,
	...
	return []any{
		...
		int64(c.Coin), int64(c.BankBalance), c.CoinVersion,
